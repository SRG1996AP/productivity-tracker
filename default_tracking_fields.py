...
def get_default_tracking_fields_by_key():
    ...
    return {
        "operations_leaders": _fields(
            ...
            {"name": "campaign_account", "label": "Campaign / Business Unit", "type": "text"},
            ...
            {"name": "frequency_per_day", "label": "Frequency per Day", "type": "number"},
            {
                "name": "status",
                "label": "Status",
                "type": "select",
                "choices": ["Completed", "In Progress", "Pending", "Escalated"],
            },
            {"name": "output_evidence", "label": "Output / Evidence", "type": "textarea"},
            {"name": "remarks", "label": "Remarks", "type": "textarea"},
        ),
        "team_leaders": _fields(
            {"name": "entry_no", "label": "No", "type": "number"},
            {"name": "team_agent_group", "label": "Team / Agent Group", "type": "text"},
        ...
        "rta": _fields(
            ...
            {"name": "client_ops_requirement", "label": "Client/OPS Requirement", "type": "text"},
            {"name": "report_name", "label": "Queue / Workforce Report Type", "type": "text"},
            {
                "name": "priority",
                "label": "Priority",
                "type": "select",
        ...
        "qa": _fields(
            ...
            {"name": "ops_client_requirement", "label": "OPS / Client Requirement", "type": "text"},
            {"name": "audit_type", "label": "Audit / Monitoring Type", "type": "text"},
        ...
        "finance": _fields(
            ...
            {"name": "ops_business_requirement", "label": "OPS / Business Requirement", "type": "text"},
            {"name": "transaction_type", "label": "Financial Process Type", "type": "text"},
...
def match_department_key(department_name):
    ...
    if "management" in name:
        return None
    if "team leader" in name or "team leaders" in name:
        return "team_leaders"
